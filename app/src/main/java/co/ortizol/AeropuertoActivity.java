...
/**
 * Clase que representa el manejo del mapa de viajes de un aeropuerto.
 */
public class AeropuertoActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mitConsultarTemperatura) {
            AlertDialog.Builder builder = new AlertDialog.Builder(AeropuertoActivity.this);
